...
hostname = 'projecserver.mysql.database.azure.com'
username = 'prabh'
password = 'P@6283973422'
database = 'testdb'

def main():
    connect_str = "DefaultEndpointsProtocol=https;AccountName=gradedstorage;AccountKey=rrOxROxv/CylLef3NqakZ1AXIDrN7vvM/fdFAY8LtRQvM4NR15CubLcRL0xBS2gp4khSib87o6AM+ASt8ZlmYw==;EndpointSuffix=core.windows.net"
